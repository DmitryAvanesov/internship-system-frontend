...
export class CompaniesEffects {
  ...
  changeCompany$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: Action & { company: CompanyModel }) =>
        this.companiesApiService.changeCompany(action.company)
      ),
  ...
  saveCompany$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: Action & { company: CompanyModel }) =>
        this.companiesApiService.createCompany(action.company)
      ),
      map((newCompany) => companyUpserted({ company: newCompany }))
    )
  );
